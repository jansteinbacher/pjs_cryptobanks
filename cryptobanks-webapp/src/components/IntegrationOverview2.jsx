    ...
    <div className="bg-white py-8 2xl:px-32 xl:px-32 sm:px-8 md:px-16 lg:px-16 mb-32">
      <div className="flex items-start justify-between w-4/5">
        <div className="text-left">
          ...
          <p className="mt-4">
            In diesem Bereich finden Sie Informationen rund um die Integration
            und den Einsatz von Kryptoassets im Bankensystem. Die Artikel sind
            in verschiedene Bereiche unterteilt und enthalten Wissenswertes aus
            der Literatur, Umfragen, Experteninterviews und Webrecherche.
          </p>
        </div>
      </div>
...
export default IntegrationOverview2;
