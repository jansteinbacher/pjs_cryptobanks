...
const CourseOverview = () => {
  ...
  return (
    <div className="max-w-screen-lg mx-auto mb-12">
      <h1 className='text-2xl font-bold text-center mb-12'>Unsere vorgefertigten Kurse</h1>
      <div className="flex items-center justify-center space-x-4 mb-8">
        {courses.map((course) => (
          <button
            ...
            } rounded-full py-2 px-4 font-semibold transition-colors duration-300 ease-in-out hover:bg-blue-600 hover:text-white`}
