    ...
    <div className="bg-white">
      <div className="max-w-screen-lg mx-auto mb-12 px-4 md:px-0">
        <div className="flex flex-col items-center justify-center space-y-4 mb-8">
          <h1 className="text-3xl font-bold text-center text-gray-800">Unsere Kursübersicht</h1>
            ...
            {courses.map((course) => (
              <button
                ...
                className={`course-button ${
                  ...
                  selectedCourse.id === course.id ? 'bg-green-400 text-white' : 'bg-gray-200 text-gray-800'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-4 bg-gray-100 rounded-lg">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">{selectedCourse.name}</h2>
          ...
          <div className="p-4 bg-gray-100 rounded-lg">
            <h2 className="mb-4 font-bold text-xl text-gray-800">Was Du in diesem Video lernen wirst:</h2>
            <div className="md:w-full h-64 md:h-auto">
              <video key={selectedCourse.id} controls className="w-full h-full rounded-lg">
        ...
        {showFloatingBar && (
          <div className="fixed bottom-0 p-4 bg-green-300 text-white rounded-t-lg ">
            <p className="text-center font-bold mb-2">
              Du bist dir nicht sicher über Deinen Kenntnisstand?
              Mache jetzt ein kurzes Quiz und erhalte eine Empfehlung.
              <button
