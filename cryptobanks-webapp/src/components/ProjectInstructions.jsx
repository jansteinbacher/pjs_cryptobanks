        ...
        <div className="fixed bottom-10 right-10 bg-white text-black px-4 py-2 border border-gray-400 rounded hidden md:block">
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              onClick={handleTooltipClickStep1}
            >
              Anleitung
            </button>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center px-4 md:px-20 bg-white text-black">
        <div className="md:w-2/3 md:mr-12">
          ...
          <p className="text-sm md:text-base mb-6">
            Unsere Lernplattform versteht die Bedeutung von maßgeschneiderten
            Kursen, die dir genau das Wissen vermittelt, das du benötigst, um in
            der Welt der Kryptoassets erfolgreich zu sein. Egal, ob du ein
            Anfänger in diesem Bereich bist oder bereits über Vorkenntnisse
            verfügst - unsere Plattform ist so gestaltet, dass sie sich auf
            deine individuellen Bedürfnisse und deinem Kenntnisstand anpassen
            lässt.
          </p>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="left-align">
              <ul className="list-disc list-inside mb-6">
                ...
                <li
                  ...
                  onClick={() =>
                    handleOptionClick("Individuelle Lerninhalte auswählen")
                  }
                >
                  <span
                    className={`w-4 h-4 border-2 border-black rounded-full mr-2 ${
                ...
                <li
                  ...
                  onClick={() =>
                    handleOptionClick("Direkt Informationen erhalten")
                  }
                >
                  <span
                    className={`w-4 h-4 border-2 border-black rounded-full mr-2 ${
            ...
            <div className="relative">
              ...
              <div
                className={
                  isTooltipStep2Visible
                    ? "bg-white text-black px-4 py-2 border border-gray-400 rounded mt-2 md:mt-0 ml-0 md:ml-12 hidden md:block"
                    : "bg-white text-white px-4 py-2 border border-white rounded mt-2 md:mt-0 ml-0 md:ml-12 hidden md:block"
                }
              >
                ...
                <div className="flex items-center justify-center">
                  <button
                    className={
                      isTooltipStep2Visible
                        ? "bg-blue-500 text-white font-semibold py-2 px-4 rounded mt-2"
                        : "bg-white text-white font-semibold py-2 px-4 rounded mt-2"
                    }
                    onClick={handleTooltipClickStep2}
                  >
                    Wählen
                  </button>
                </div>
          ...
          <div className="flex">
            ...
            <div className="relative">
              ...
              <div
                className={
                  isTooltipStep3Visible
                    ? "bg-white text-black px-4 py-2 border border-gray-400 rounded ml-4 hidden md:block"
                    : "bg-white text-white px-4 py-2 border border-white rounded ml-4 hidden md:block"
                }
              >
                <p className="text-center">
                  &#8592; Gelange zu deinem ausgewählten Bereich.
                </p>
              </div>
            </div>
          </div>
