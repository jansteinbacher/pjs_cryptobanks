  ...
  return (
    <div className="bg-white">
      <div className="container mx-auto py-12 px-12 max-w-screen-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center rounded-lg border border-gray-300 p-8 hover:bg-green-100 mb-16">
          {/* Image */}
          ...
          <div className="md:col-span-1">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Experteninterviews</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center rounded-lg border border-gray-300 p-8 hover:bg-green-100 mb-16">
          ...
          {/* Text Content */}
          <div className="md:col-span-1">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Myth Busters</h2>
            <p className="text-gray-600 mb-6">
              In der Welt von Krypto gibt es einige Mythen. Wir untersuchen diese und zeigen auf, was daran wahr ist und was doch nur ein Mythos bleibt.
            </p>
            <a
              href="/mythbusters"
              className="inline-flex items-center space-x-2 bg-green-400 text-white font-semibold px-6 py-3 rounded-md shadow-md hover:bg-green-500 transition"
