    ...
    <div className="container mx-auto py-12 px-12 max-w-screen-lg">
      ...
      <div className="p-4 mb-12 bg-green-200 rounded-lg">
        <p className=" italic text-justify">
          Während Bernd sich intensiv mit dem Thema Blockchain auseinandersetzt,
          stolpert er immer wieder über den Begriff "Distributed Ledger
          Technology" (DLT). Er ist sich nicht sicher, ob Blockchain und DLT
          dasselbe sind, und beschließt, Tobias nach dessen Meinung zu fragen.
        </p>
      </div>
