...
function CryptoAssetsExpertInterviewPart8() {
  const expertData = [
    ...
    },
    {
      ...
      imageSrc: Jonathan,
      characteristics:
        'ist als Chief Marketing Officer bei SWIFT tätig. Er hält einen Master in Corporate Performance und Restructuring. SWIAT ist ein in Frankfurt ansässiges FinTech. Es entwickelt Blockchain-Software für eine offene dezentralisierte Finanzmarktinfrastruktur. Es wurde von Finanzunternehmen für die Finanzindustrie entwickelt. Das Netzwerk setzt auf Kooperationen, um gemeinsam die infrastrukturelle Fragmentierung im DLT-Umfeld zu überwinden und dennoch im Wettbewerb zu bleiben. (SWIAT, 2023).',
    },
    {
      id: 2,
      name: 'Niclas Voigt',
      imageSrc: Niclas,
      characteristics:
        'ist als Senior Manager bei der Commerzbank tätig. Er hat einen Master in Wirtschaftsinformatik. Zudem hält er ein Zertifikat des Venture Finance Programms der Universität Oxford. Die Commerzbank gliedert sich in zwei Geschäftsbereiche – Privat- und Unternehmerkunden sowie Firmenkunden – und bietet ein breites Portfolio an Finanzdienstleistungen an. Sie konzentriert sich auf den deutschen Mittelstand, Großunternehmen sowie institutionelle Kunden. Im internationalen Geschäft begleitet die Commerzbank Kunden mit einem Geschäftsbezug zu Deutschland und Unternehmen aus ausgewählten Zukunftsbranchen (Commerzbank AG, 2023).',
    },
    {
      id: 2,
      name: 'Adam Zgraja',
