  ...
  const questions = [
    {
      ...
      options: [
        ...
        'Einzigartige Token, die den Besitz spezifischer Vermögenswerte repräsentieren',
        'Token, die ausschließlich für Zahlungen verwendet werden',
    ...
    },
    {
      ...
      options: [
        'Die Erreichung von Preisstabilität auf dem Kryptowährungsmarkt',
        'Die Ermöglichung schneller und kostengünstiger Transaktionen',
        'Die Repräsentation des Eigentums an physischen Vermögenswerten',
        'Die Verwendung als Utility-Token für Blockchain-Anwendungen',
      ],
    ...
    },
    {
      ...
      options: [
        'Sie repräsentieren das Eigentum an physischen Vermögenswerten.',
        'Sie sind immer nicht übertragbar.',
        'Sie gewähren spezifische Nutzungsrechte innerhalb einer Blockchain-Anwendung.',
        'Sie werden ausschließlich für den Handel auf Kryptowährungsbörsen verwendet.',
      ],
