    ...
    <div className="container mx-auto py-12 px-12 max-w-screen-lg">
      ...
      {isComingFromPreviousPage && (
        <div className="p-4 mb-12 bg-green-200 rounded-lg">
          ...
          Nachdem Tobias einiges über die Verantwortung für die Sicherung und das Management 
          von Kryptoassets gelernt hat, möchte er genauer die Art und Weise verstehen, 
          inwiefern das Eigentum und die Kontrolle über die Vermögenswerte auf verschiedene Unternehmen verteilt sind.
          </p>
        </div>
      )}

      <p className="mb-8">
      Bei der zentralisierten Kryptoasset-Verwahrlösung hat eine einzelne Entität den vollen Zugriff 
      auf die Kryptoassets und übernimmt die Sicherheit <a href="#sources">[7]</a>.
        
      </p>

      <p className="mb-8">
      Wiederum die dezentrale Kryptoasset-Verwahrlösung verteilt die Kontrolle und das Management 
      der Kryptoassets auf verschiedene Entitäten. Hierfür wird unter anderem die Distributed-Ledger-Technologie 
      genutzt, wie es bei Qredo der Fall ist. <a href="#sources">[8]</a>
...
export default ApplicationAreaPart3;
