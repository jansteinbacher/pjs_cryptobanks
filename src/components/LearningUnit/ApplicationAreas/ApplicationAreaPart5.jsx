    ...
    <div className="container mx-auto py-12 px-12 max-w-screen-lg">
      ...
      {isComingFromPreviousPage && (
        <div className="p-4 mb-12 bg-green-200 rounded-lg">
          ...
          Tobias weiß nun, dass er seinen privaten Schlüssel bisher nur in einer Software Wallet gespeichert hat, 
          die leider auch anfällig für Cyberangriffen sein können. Aus diesem Grund möchte er weitere Methoden der 
          Lagerung des Schlüssels kennenlernen, um zukünftig sicherer aufgestellt zu sein.
          </p>
        </div>
      )}

      <p className="mb-8">
      Eine Hardware-Wallet bietet ein hohes Maß an Sicherheit, indem der private Schlüssel auf einem physischen Gerät, 
      wie einer Festplatte gespeichert wird und so das Risiko von Cyberangriffen verringert wird. 
      Alle Transaktionen werden hierbei im Gerät signiert, 
      wodurch der Schlüssel niemals dieses verlässt.<a href="#sources">[12]</a>
        
      </p>

      <p className="mb-8">
      Wiederum sind Hadware Sicherheitsmodule (HSMs) besonders manipulationssichere physische Geräte, 
      die zusätzlich Funktionen wie Verschlüsselung, Entschlüsselung und Authentifizierung bieten. 
      Diese kommen in zwei Ausprägungen vor: Premise-HSMs und Cloud-HSMs. 
      Die Vorteile von HSMs liegen in der Einhaltung von Sicherheitsstandards, 
      starken Authentifizierung und maipulationsicheren Systemen. <a href="#sources">[13]</a>
      Dennoch haben sie auch Nachteile, wie der Bedarf an physischen Zugang, 
      begrenzte Skalierbarkeit und Kompatibilitätsprobleme. <a href="#sources">[14]</a>
