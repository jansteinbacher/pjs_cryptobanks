    ...
    <footer className="bg-green-100 py-6">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex space-x-6 text-gray-600">
          ...
          <a href='/course-overview' className="hover:text-gray-800 transition">Kurse</a>
          <a href='/decisiontree' className="hover:text-gray-800 transition">Individueller Kurs</a>
          <a href='/overview' className="hover:text-gray-800 transition">Glossar</a>
        </div>
      </div>
    </footer>
  );
