    ...
    <footer className="bg-green-100 py-6 w-full mt-24">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between h-full mb-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          {/* Render the FooterLogo component with the Logo image */}
          <div className="mt-4 text-center md:text-left">
            {' '}
            {/* Text content */}
            <p>Cryptobanks bietet E-Learning Kurse</p> {/* Line 1 of text */}
            <p>für Bankangestellte zum Thema Kryptoassets.</p>{' '}
            {/* Line 2 of text */}
          </div>
        </div>
        <NavigationLinks />{' '}
        {/* Render the NavigationLinks component for navigation links */}
      </div>
    </footer>
  );
}
